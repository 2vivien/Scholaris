            ...
            <main className="flex-1 p-6 lg:p-8 max-w-7xl mx-auto w-full">
                ...
                <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                    <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                        <h2 className="text-sm font-semibold text-slate-900">Établissements</h2>
                    ...
                    {loading ? (
                        ...
                        <div className="p-16 text-center">
                            ...
                            <p className="text-sm font-medium text-slate-400">
                                {search ? 'Aucun résultat pour cette recherche.' : 'Aucun établissement pour le moment.'}
                            </p>
                            {!search && (
                                <button
                                    onClick={() => setIsAddModalOpen(true)}
                                ...
                                >
                                    <Plus className="w-3.5 h-3.5" /> Créer le premier établissement
                                </button>
                            )}
                        </div>
                    ) : (
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-slate-100 bg-slate-50/60">
                                        <th className="text-left px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Établissement</th>
                                        <th className="text-left px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Sous-domaine</th>
                                        ...
                                        <th className="text-left px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Utilisateurs</th>
